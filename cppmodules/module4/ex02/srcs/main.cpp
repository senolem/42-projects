...
/*   Updated: 2022/09/12 15:55:18 by albaur           ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main(void)
{
	...
	//With abstract classes, you can create a pointer to an instance
	//like this :
	//const Animal* icanexist = new Dog();
	//but you can't instantiate an object of an abstract class
	//like this :
	//const Animal* icannotexist = new Animal();
